...
- AI search adoption accelerated through early–mid 2026 (Google's AI Mode passed 1 billion monthly users at I/O 2026, with follow-up queries up 40%+ month-over-month). ChatGPT-driven local traffic is growing fast but still a fraction of Google's total — directional, not dominant yet
...
- Zero-click is the norm: AI Overviews/AI Mode answer many local queries in-SERP (industry estimates put the organic-click reduction near ~58% for affected queries). Measure GBP actions and on-site conversions, not raw clicks
...
- FAQ schema for common questions (note: FAQ rich results were dropped in 2026 — FAQPage still aids AI parsing, but no longer yields SERP rich results)
...
> **2026 — earned, not bought.** Google's first official AI-search guide (May 2026) states its spam policies apply to AI features and warns against *manipulating or buying* citations/mentions to influence AI results. Pursue genuinely earned mentions; engineered or paid placements aimed at AI visibility are a stated spam risk.
...
- Q&A data accurate (Google is moving to AI-generated Q&A — ensure profile/website data supports correct answers, and review AI-suggested answers before they publish)
...
| Entity is unclear/fragmented across the web | Build entity & brand authority (`sameAs`, branded demand) | `entity-authority` |
