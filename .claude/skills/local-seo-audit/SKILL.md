...
- [ ] No stock photos
- [ ] (Skip geo-tagging — Google strips EXIF on upload; geotagged photos have no ranking effect)

### Engagement Signals
- [ ] GBP posts within last 7 days
- [ ] Q&A data accurate (Google is replacing Maps Q&A with AI-generated Q&A — ensure profile/website data supports correct AI answers)
- [ ] Reviews being responded to
- [ ] Call/website CTAs strong (GBP chat/messaging is being retired July 2026 — don't rely on it)
