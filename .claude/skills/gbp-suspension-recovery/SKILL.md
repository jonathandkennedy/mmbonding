...
description: When the user's Google Business Profile has been suspended, disabled, or is under review. Also use when the user mentions "suspended," "GBP suspension," "listing disabled," "profile removed," "reinstatement," "Google suspended my business," "guideline violation," or "my listing disappeared." For general GBP optimization, see gbp-optimization.
metadata:
  version: 1.1.0
...
1. **Google Business support chat/phone**: Request escalation to specialist team
2. **Google Business community forum**: Post with details, top contributors may escalate
3. **Twitter/X @GoogleMyBiz**: Sometimes gets attention
4. **Google Business redressal form**: For competitor-caused issues
5. **Legal/formal complaint**: Last resort for legitimate businesses
...
| A competitor's spam is the real problem | Report their violations (separate from your reinstatement) | `gbp-spam-enforcement` |
