...
description: When the user wants to generate more reviews, respond to reviews, build a review strategy, or manage online reputation. Also use when the user mentions "reviews," "reputation management," "review generation," "review response," "star rating," "negative reviews," or "get more Google reviews." For GBP profile optimization, see gbp-optimization.
metadata:
  version: 1.3.0
...
1. **Current State**: Total reviews, average rating, review velocity, response rate
2. **Competitors**: How many reviews do top-3 map pack competitors have?
3. **Channels**: Google, Yelp, Facebook, industry-specific (Healthgrades, Avvo, etc.)
4. **Capacity**: Who handles review responses? How quickly?
...
### The Ask Framework
1. **Identify the moment**: After service completion, positive interaction, or milestone
2. **Ask in person first**: Verbal ask is highest-converting
3. **Follow up digitally**: SMS > Email for response rates
4. **Make it easy**: Direct link to Google review form
5. **Don't incentivize**: Offering rewards for reviews violates Google guidelines
6. **Ask cleanly (2026 policy)**: Don't ask customers to mention a specific staff member, use specific words, or leave a specific star rating, and don't offer discounts/gifts/prizes. Google tightened review-solicitation enforcement in 2026 — neutral asks only ("Would you mind sharing your experience on Google?")
...
2. **Apologize**: For the experience (not admitting fault)
3. **Take offline**: Provide a direct contact for resolution
...
### Removal Process
1. Flag the review in GBP (⋮ menu → Flag as inappropriate)
...
## 2026 Review Policy & Enforcement (Compliance + Attack Response)

Google overhauled review enforcement in 2026. Getting this wrong now costs reviews, profile visibility, and rankings — and several long-standing tactics are now explicit violations.

**Now explicitly prohibited (Rating Manipulation / Fake Engagement policies):**
- **Review gating** — filtering who gets a review request by expected sentiment, transaction size, or staff judgment. Requests must go to all customers equally.
- **Staff review quotas** and asking customers to **mention a specific employee by name**.
- **Asking customers to use specific words or leave a specific star rating.** This also retires the old "ask reviewers to mention keywords" justification tactic — earn it via on-page content and natural prompts instead (see `gbp-justifications`).
- **Keyword-stuffing or promotional language in review responses** (links, discount offers) — flagged as manipulation. Responses must address the actual feedback.
- Incentivizing reviews with discounts/gifts/prizes — still banned.

**Automatic enforcement on a spam spike (Fake Engagement policy):** when Google detects a sudden spike in spam reviews it now (1) removes the fake content, (2) pauses new reviews on the profile, (3) alerts the owner, and (4) can display a **public banner to consumers** stating reviews were paused. That banner is a reputational cost even when you are the victim of an attack.

**If you're hit by a review-bomb / fake-review attack:**
- Flag each violating review in the Reviews Management Tool and report the pattern. → `gbp-spam-enforcement`.
- **Do not** rush to replace removed reviews with a burst of new ones — a sudden volume spike triggers further automated filtering. Resume normal, steady velocity.
- Expect, and explain to the client, the temporary public banner if Google paused reviews.

**Compliant asking, restated:** prompt every customer equally, at the moment service was delivered, with a neutral request ("we'd love your honest feedback on Google") and a direct link. No sentiment screening, no scripted words, no staff-name asks, no incentives.

---

## Task-Specific Questions

1. How many Google reviews do you currently have?
2. What's your current review velocity (reviews/month)?
3. How many reviews do your top map pack competitors have?
4. Who will be responsible for review responses?
5. What's your primary method of customer communication (email, SMS, in-person)?
