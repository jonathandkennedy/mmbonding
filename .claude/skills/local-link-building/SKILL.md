...
> **2026 — earned, not bought (AI-search policy).** Local mentions, "best of [city]" features, and authoritative citations matter *more* now because AI search (AI Overviews, AI Mode, ChatGPT, Gemini) leans on them as trust/citation signals. But Google's first official AI-search guidance (May 2026) states its spam policies apply to AI features and warns against *manipulating or buying* citations to influence AI results. Keep links and mentions genuinely earned — paid placements engineered for AI visibility are now a stated spam risk.
