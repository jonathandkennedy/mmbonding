...
> **2026 note:** Google dropped FAQ rich results, so FAQPage schema no longer yields SERP rich results — keep it as an AI-parsing aid, not a rich-result play. Direct-answer formatting (question heading + 2–3 sentence answer) matters more than ever for AI Overviews / AI Mode citation.
