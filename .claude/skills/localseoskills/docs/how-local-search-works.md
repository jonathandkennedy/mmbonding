...
- Linked social — Google indexes content from *linked, active* social accounts and can surface their offers/events on the profile. Social *signals* (likes/shares) are not a confirmed direct ranking factor, though; the durable signal is engagement and freshness, not likes
...
- **Q&A** — Visible on the listing. Google is replacing user-facing Maps Q&A with AI-generated Q&A (answers drawn from profile/reviews/website, gated behind owner review). Keep underlying data accurate so AI answers are right; review AI-suggested answers before they publish
- **Messaging** — GBP chat/messaging is being retired (new conversations end July 15, 2026; chat fully ends July 31, 2026), with WhatsApp as the replacement. Don't rely on it
