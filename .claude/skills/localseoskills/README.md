...
<p align="center">
  <strong>46 open-source skills that turn Claude into a local SEO specialist.</strong><br/>
...
Pick the path for your setup. However you install, the 46 skills end up where your agent can find them.
...
- **34 strategy skills:** GBP optimization, audits, citations, reviews, keywords, geogrid, content, AI visibility, multi-location SEO, client deliverables, a dispatch router that picks the right skills for every request, and more
...
- **16 scheduled task templates:** monitoring, reporting, execution, and prospecting workflows that run on Anthropic's cloud, even when your computer is off
...
16 task templates that turn Local SEO Skills into always-on local SEO software. Tasks run on Anthropic's cloud infrastructure. No server required, works even when your computer is off.
...
| E5 | Local News Posts | Twice monthly, 1st & 15th 8am | Queue |
...
| [local-news-posts](skills/local-news-posts) | Build GBP posts from local news and topical/seasonal trends, with advertising-compliance guardrails for regulated verticals |
...
| [evidence-standards](skills/evidence-standards) | The honesty layer — assigns a confidence tier to every ranking claim (Google-confirmed → controlled test → correlation → opinion → vendor) |
| [local-seo-experiments](skills/local-seo-experiments) | Controlled causal testing — isolate a variable, baseline, control, and prove whether a change actually moves rankings |
| [gbp-spam-enforcement](skills/gbp-spam-enforcement) | Audit and report competitor GBP spam, and defend against review-bombing and engagement attacks |
| [gbp-justifications](skills/gbp-justifications) | Influence the local pack justification snippets to win the click |
| [behavioral-engagement](skills/behavioral-engagement) | Legitimate engagement/CTR optimization and manipulation-attack defense (no click manipulation) |
| [entity-authority](skills/entity-authority) | Build entity and brand authority (`sameAs`, knowledge panel, branded demand) for prominence and AI visibility |
| [proximity-location-strategy](skills/proximity-location-strategy) | The legitimate proximity playbook — pin/address, hours, site selection, extending ranking radius |
