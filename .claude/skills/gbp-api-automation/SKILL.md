...
- **Posts**: GBP post creation via API. (2026: Google also added native multi-location post scheduling in the GBP UI — useful when full API automation isn't needed. The GBP-in-Gemini assistant does not support managers of more than one verified profile.)
